...
- Accès cPanel
- Domaine configuré : sbn.soon22.fr
...
MAIL_PORT=587
MAIL_USERNAME=noreply@sbn.soon22.fr
MAIL_PASSWORD=votre_password
MAIL_FROM=noreply@sbn.soon22.fr
...
1. Créer l'adresse email `noreply@sbn.soon22.fr`
